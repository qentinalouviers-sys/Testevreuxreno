const fr = {
  ...
  pro: {
    ...
    register: {
      ...
      accountType: {
        ...
        producer: "Producteur",
        producerNote: "Je vends mes produits",
        buyer: "Acheteur professionnel",
        buyerNote: "J'achète pour mon établissement",
      },
    ...
    buyer: {
      ...
      discount: "Votre remise catalogue",
      discountNote: "Remise négociée, appliquée automatiquement sur tout le catalogue.",
      catalogCta: "Parcourir la sélection",
      none: "Aucune remise négociée pour le moment.",
      approved: "Compte acheteur validé",
    },
    status: {
  ...
  admin: {
    ...
    pricing: {
      ...
      type: "Type",
      simulation: "Sur une commande de 100 €",
      producerGets: "Le producteur reçoit",
      platformGets: "La plateforme garde",
      buyerDiscount: "Remise catalogue",
      commissionLabel: "Commission plateforme",
      dragHint: "Faites glisser pour ajuster",
      save: "Enregistrer",
